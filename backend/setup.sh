...
# RoyalEstate Backend Quick Setup Script
# This script helps you set up the RoyalEstate backend quickly
...
# Header
print_header "🏠 RoyalEstate Backend Setup"
print_header "============================"
echo ""
...
MONGO_URI=mongodb://localhost:27017/royalEstate
