...
const HomePage: React.FC = () => {
  useSEO({
    ...
    description: 'Expanzia Properties offers AI-powered property search, location trends analysis, and investment insights to find your perfect property in India.',
  });
